#!/usr/bin/env node
// CommonJS wrapper copy of view_firestore_admin.js to support projects using "type": "module"
...
if (opts.help) {
  console.log('Usage: node tool/view_firestore_admin.cjs [--key path/to/serviceAccount.json] [--limit N] [--writeSmoke] [--smokeId id]');
  process.exit(0);
}
