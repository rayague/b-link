...
void main() {
  ...
  group('MessageRepository Tests', () {
    ...
    test('should return empty list for non-existent relation', () async {
      ...
      final messages = await repository.getMessagesByRelation('INVALID_RELATION');
    ...
    test('should handle null when getting random message for invalid relation', () async {
      await repository.init();
      
      final message = await repository.getRandomMessageByRelation('INVALID_RELATION');
